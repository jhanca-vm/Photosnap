<style>
  ...
  figure:hover .facebook path {
    fill: url(#f);
  }

  figure:hover .youtube path {
    fill: url(#y);
  }

  figure:hover .twitter path {
    fill: url(#t);
  }

  figure:hover .pinterest path {
    fill: url(#p);
  }
...
<div>
  ...
  <figure>
    <svg class="youtube" width="21" height="20">
      <defs>
        <linearGradient id="y" x1="0%" x2="100%" y1="100%" y2="0%">
  ...
  <figure>
    <svg class="twitter" width="21" height="18">
      <defs>
        <linearGradient id="t" x1="100%" x2="0%" y1="16.979%" y2="83.021%">
  ...
  <figure>
    <svg class="pinterest" width="20" height="20">
      <defs>
        <linearGradient id="p" x1="100%" x2="0%" y1="0%" y2="100%">
  ...
  <figure>
    <svg class="instagram" width="21" height="20">
      <defs>
        <linearGradient id="i" x1="0%" x2="50%" y1="100%" y2="0%">
